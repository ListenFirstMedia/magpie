...
SRC = HERE / "QA-533-report.md"
OUT = HERE / "QA-533-report.pdf"
...
@page {
  ...
  @bottom-center {
    content: "LF-Regression — QA-533 Run 2026-05-13   ·   Page " counter(page) " of " counter(pages);
...
<html>
<head><meta charset="utf-8"><title>LF-Regression QA-533 Run 2026-05-13</title></head>
<body>{html_body}</body>
</html>"""
