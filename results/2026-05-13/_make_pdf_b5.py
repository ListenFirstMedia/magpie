...
SRC = HERE / "batch5-summary.md"
OUT = HERE / "batch5-summary.pdf"
...
@page {
  ...
  @bottom-center {
    content: "LF-Regression — Batch 5 Run 2026-05-13   ·   Page " counter(page) " of " counter(pages);
...
<html>
<head><meta charset="utf-8"><title>LF-Regression Batch 5 Run 2026-05-13</title></head>
<body>{html_body}</body>
</html>"""
