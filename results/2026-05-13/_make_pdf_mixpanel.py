...
SRC = HERE / "QA-18866-QA-40815-report.md"
OUT = HERE / "QA-18866-QA-40815-report.pdf"
...
@page {
  ...
  @bottom-center {
    content: "LF-Regression — Mixpanel cases blocked   ·   Page " counter(page) " of " counter(pages);
...
<html>
<head><meta charset="utf-8"><title>LF-Regression Mixpanel cases blocked</title></head>
<body>{html_body}</body>
</html>"""
